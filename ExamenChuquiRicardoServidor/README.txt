...
a persistence unit "ExamenChuquiRicardoServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenChuquiRicardoServidor\pom.xml":
...
artifact ("ExamenChuquiRicardoServidor.war") is already built. You can build
